...
CREATE TABLE IF NOT EXISTS `enjoytrip`.`board` (
                                                   ...
                                                   CONSTRAINT `board_to_user_user_no_fk`
                                                       FOREIGN KEY (`user_no`)
                                                           REFERENCES `enjoytrip`.`user` (`user_no`)) ON DELETE CASCADE
    ENGINE = InnoDB
    DEFAULT CHARACTER SET = utf8mb4
    COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `enjoytrip`.`board_attraction_map` (
                                                                  ...
                                                                  CONSTRAINT `map_to_attraction_info_content_id_fk`
                                                                      FOREIGN KEY (`content_id`)
                                                                          REFERENCES `enjoytrip`.`attraction_info` (`content_id`) ON DELETE CASCADE ,
                                                                  CONSTRAINT `map_to_board_post_id_fk`
                                                                      FOREIGN KEY (`post_id`)
                                                                          REFERENCES `enjoytrip`.`board` (`post_id`)) ON DELETE CASCADE
    ENGINE = InnoDB
    DEFAULT CHARACTER SET = utf8mb4
    COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `enjoytrip`.`comment` (
                         ...
                         CONSTRAINT comment_to_board_post_id_fk FOREIGN KEY (post_id) REFERENCES board(post_id) on delete CASCADE
