      ...
      <div>
        <b-tabs content-class="mt-3">
          ...
          <b-tab title="프로필 정보 수정">
            <div class="col-12">
              <table
                class="table table-borderless display-flex p-3"
              ...
              <div class="col-md">
                <div class="custom-control custom-checkbox">
                  ...
                  <label class="custom-control-label" for="deleteConfirm"
                    >회원 탈퇴시 저장된 회원 정보가 사라지는 것을 이해했으며,
                    회원 탈퇴에 동의합니다.</label
                  >
                </div>
                <button
                  class="btn btn-primary btn-lg btn-danger btn-block m-1"
                  id="deleteUser"
                  @click="deleteUser()"
                >
                  회원 탈퇴
